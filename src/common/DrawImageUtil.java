...
public class DrawImageUtil {
    ...
    private static void setBackGround(Graphics g) {
        // 设置颜色
        g.setColor(new Color(242,243,241));
        // 填充区域
    ...
    private static void setBorder(Graphics g) {
        // 设置边框颜色
        g.setColor(new Color(249,249,245));
        // 边框区域
    ...
    private static void drawRandomLine(Graphics g) {
        // 设置颜色
        g.setColor(new Color(215,221,224));
        // 设置线条个数并画线
        for (int i = 0; i < 30; i++) {
    ...
    private static String drawRandomNum(Graphics2D g) {
        ...
        // 设置颜色
        g.setColor(new Color(54,116,163));
        // 设置字体
